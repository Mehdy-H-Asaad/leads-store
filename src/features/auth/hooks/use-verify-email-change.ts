...
export const useVerifyEmailChange = () => {
	...
	const { mutate, isPending } = useApiMutation<TUserDTO, TVerifyEmailChangeSchema>(
		{
			mutationFn: data => authService.verifyEmailChange(authMapper.toVerifyEmailChangeDto(data)),
