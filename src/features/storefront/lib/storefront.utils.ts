...
import type {
	...
	TCustomizationTheme,
} from "@/entities/customization/model/customization.model";
...
export function getBackgroundStyle(theme: TCustomizationTheme): CSSProperties {
	if (
...
export function getContainerStyle(theme: TCustomizationTheme): CSSProperties {
	return {
		color: theme.text,
		fontFamily:
...
export function getCardStyle(theme: TCustomizationTheme): CSSProperties {
